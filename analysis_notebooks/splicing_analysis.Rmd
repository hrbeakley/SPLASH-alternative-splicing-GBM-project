...
# This script annotates anchors with known genes and splice junctions
...
```{r}
###### SPLASH output file ############
splash_file = '/projectnb/bf527/students/hbeakley/project/results/result.after_correction.scores.tsv'
####################################
...
STAR_index_path = "/projectnb/bf527/students/hbeakley/project/results/star_index"  # path to the folder containing STAR index files
known_splice_sites_file = "/projectnb/bf527/students/hbeakley/project/results/annotations/T2T_known_splice_sites.txt" # the file containing known splice sites extracted from the reference gtf file
known_exon_boundaries_file = "/projectnb/bf527/students/hbeakley/project/results/annotations/T2T_exon_coordinates.bed" # path to the file containing the known exon coordinates
gene_coordinates_file = "/projectnb/bf527/students/hbeakley/project/results/annotations/T2T_genes.bed" # path to the file file containing gene coordinates
...
STAR_executable_file = "singularity exec docker://ghcr.io/bf528/star:latest STAR"
samtools_executable_file = "singularity exec docker://ghcr.io/bf528/homer_samtools:latest samtools"
bedtools_executable_file = "singularity exec docker://ghcr.io/bf528/bedtools:latest bedtools"

system(paste(STAR_executable_file, "--version"))
...
anchors[, extendor_order := seq_len(.N), by = anchor]
...
```{r}
##################################################################################################################################
splicing_anchors <- anchors[!is.na(STAR_chr)]
write.table(
  splicing_anchors,
  file = file.path(directory, "splicing_anchors.tsv"),
  sep = "\t",
  quote = FALSE,
  row.names = FALSE
)
